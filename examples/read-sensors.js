 ...
 * 5. For each sensor, log useful properties (here: reading, event
 *    state (such as "Too High" for temperature), and whether it is
 *    armed (meaning that events trigger alerts, such as push notification).
 * 6. Keep looping for a set period of time by updating the data for
 *    each tag at the interval configured for each tag.
 * 
